      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item active">
            <a class="nav-link" href="Jadwal.php">Jadwal Dokter <span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item">
...
<div class="container" style="min-height: 100%">
  ...
  <table class="table table-hover" style="text-align: center;">
    <thead style="background-color: rgb(0, 123, 59); color: white;">
    ...
    while ($listdokter = mysqli_fetch_array($getdoctor)) {
      echo "<tr>";      
      echo "<td>".$listdokter['spesialis']."</td>";
