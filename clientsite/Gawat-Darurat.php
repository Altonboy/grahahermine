...
require '../assets/core/init.php';
  ...
  $getigd = mysqli_query($connect, "SELECT * FROM daftar_layanan WHERE kategoriLayanan = 'Unit Gawat Darurat'");
?>
<html>
<head>
...
<div class="container" style="min-height: 100%;">
  <h3>LAYANAN GAWAT DARURAT</h3> <br>

  <div class="layanan">
    <?php
          while ($listigd = mysqli_fetch_array($getigd)) {
            echo "<a href='Pelayanan.php?id=$listigd[layananID]'>";
    echo"<div class='imgcontainer'>";
      echo"<div class='imgheader'>";
        echo"<h5>".$listigd['namaLayanan']."</h5>";
      echo"</div>";
      echo"<img src='../assets/images/".$listigd['fotoUtama']."' width='100%'>";
    echo"</div></a>";
    } ?>
  </div>
</div> <br>
