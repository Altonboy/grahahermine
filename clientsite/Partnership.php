...
require '../assets/core/init.php';
 ...
 if (isset($_POST['filtera'])) {
  ...
  $getpartnership = mysqli_query($connect, "SELECT * FROM partnership WHERE namaPartnership LIKE '$filter%' ORDER BY namaPartnership ASC");
} 
...
elseif (isset($_POST['fasuransi'])) {
  $filter = $_POST['fasuransi'];
  $getpartnership = mysqli_query($connect, "SELECT * FROM partnership WHERE kategori = 'Asuransi' ORDER BY namaPartnership ASC");
}

elseif (isset($_POST['fperusahaan'])) {
  $filter = $_POST['fperusahaan'];
  $getpartnership = mysqli_query($connect, "SELECT * FROM partnership WHERE kategori = 'Perusahaan' ORDER BY namaPartnership ASC");
}

else {
  $getpartnership = mysqli_query($connect, "SELECT * FROM partnership ORDER BY namaPartnership ASC");
}
?>
<html>
<head>
...
<div class="container" style="min-height: 100%;">
  ...
  <div class="row">
    ...
    <div class="col-sm">
      <button class="btn-success" style="width: 100%" type="submit" name="fasuransi">ASURANSI</button>
    </div>
    <div class="col-sm">
      <button class="btn-success" style="width: 100%" type="submit" name="fperusahaan">PERUSAHAAN</button>
    </div>
    <div class="col-sm">
    </div>
  </div>
  ...
  <div class="partnership">
    <?php
      while ($listpartnership = mysqli_fetch_array($getpartnership)) {
        echo"<div class='imgcontainer'>";
          echo"<div class='imgheader'>";
            echo"<h5>".$listpartnership['namaPartnership']."</h5>";
          echo"</div>";
          echo"<img src='../assets/images/".$listpartnership['namaFoto']."' width='100%'>";
        echo"</div>";
      }?>
  </div>
