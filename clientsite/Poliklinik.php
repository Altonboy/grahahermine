...
require '../assets/core/init.php';
  ...
  $getpoliklinik = mysqli_query($connect, "SELECT * FROM daftar_layanan WHERE kategoriLayanan = 'Poliklinik'");
?>
<html>
<head>
...
<div class="container" style="min-height: 100%;">
  <h3>LAYANAN POLIKLINIK</h3> <br>

  <div class="layanan">
    <?php
          while ($listpoliklinik = mysqli_fetch_array($getpoliklinik)) {
            echo "<a href='Pelayanan.php?id=$listpoliklinik[layananID]'>";
    echo"<div class='imgcontainer'>";
      echo"<div class='imgheader'>";
        echo"<h5>".$listpoliklinik['namaLayanan']."</h5>";
      echo"</div>";
      echo"<img src='../assets/images/".$listpoliklinik['fotoUtama']."' width='100%'>";
    echo"</div></a>";
    } ?>
  </div>
</div> <br>
