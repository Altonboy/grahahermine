...
require '../assets/core/init.php';
  ...
  $getida = mysqli_query($connect, "SELECT * FROM daftar_layanan WHERE kategoriLayanan = 'Ibu dan Anak'");
?>
<html>
<head>
...
<div class="container" style="min-height: 100%;">
  <h3>LAYANAN IBU DAN ANAK</h3> <br>

  <div class="layanan">
    <?php
          while ($listida = mysqli_fetch_array($getida)) {
            echo "<a href='Pelayanan.php?id=$listida[layananID]'>";
    echo"<div class='imgcontainer'>";
      echo"<div class='imgheader'>";
        echo"<h5>".$listida['namaLayanan']."</h5>";
      echo"</div>";
      echo"<img src='../assets/images/".$listida['fotoUtama']."' width='100%'>";
    echo"</div></a>";
    } ?>
  </div>
</div> <br>
