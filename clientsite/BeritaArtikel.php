    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="collapse navbar-collapse" id="navbarNavDropdown">
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          ...
          <a class="nav-link" href="BeritaArtikel.php">Berita dan Artikel<span class="sr-only">(current)</span></a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbarDropdownMenuLink" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              Informasi
...
<div class="container" style="min-height: 100%;">
  <h3>BERITA DAN ARTIKEL</h3> <br>

  <?php
  while($listartikel = mysqli_fetch_array($result)){
  echo "<a href='ShowBerita.php?id=$listartikel[artikelID]'>";

  echo"<div class='artikel'>";
      echo"<img src='../assets/images/".$listartikel['namaFoto']."' width='100%'>";
      echo"<div class='artikeltext' style='margin-left:10px'>";
        echo"<h4>".$listartikel['judulArtikel']."</h4>";
        echo"<small class='text-muted' style='text-align: left; margin: 0; padding: 0'><i>".$listartikel['tanggalArtikel']."</i></small>";
        echo"<div style='width: 100%; background-color: rgb(0, 123, 59); margin: auto;'><hr></div>";
  echo"<p class='text-truncate' style='text-align: right;'>".$listartikel['isiArtikel']."</p>";
    echo"</div></div></a><br><br>";
} ?>
</div>
<br>
