...
<div class="container" style="min-height: 100%;">
  <div class="row">
    <div class="col-sm" style="margin: 1%">
      ...
      <div class="accordion" id="showfaq">
        <?php
          while($listfaq = mysqli_fetch_array($getfaq)){
            echo "<div class='card'>";
              echo "<div class='card-header' id='heading".$listfaq['faqID']."'>";
                echo "<h5 class='mb-0'>";
                  echo "<button class='btn btn-link' type='button' data-toggle='collapse' data-target='#collapse".$listfaq['faqID']."' aria-expanded='true' aria-controls='collapse".$listfaq['faqID']."' style='text-decoration:none; color:rgb(0, 123, 59);'>";
                    echo $listfaq['pertanyaan'];
                  echo "</button>";
                echo "</h5>";
              echo "</div>";

              echo "<div id='collapse".$listfaq['faqID']."' class='collapse show' aria-labelledby='heading".$listfaq['faqID']."' data-parent='#showfaq'>";
                echo "<div class='card-body'>";
                  echo  $listfaq['jawaban'];
                echo "</div>";
              echo "</div>";
            echo "</div> ";
          } ?>
    ...
    <div class="col-sm" style="margin: 1%">
      <h3>HUBUNGI KAMI</h3>
        <form action="FAQ.php" method="POST">
          <div class="formhubungikami">
            <div style="width: 100%; background-color: rgb(0, 123, 59); margin: auto;"><hr></div>
            <input type="text" name="namalengkap" class="form-control" style="width: 60%" placeholder="Nama"> <br>
            <input type="email" name="emailpengirim" class="form-control" style="width: 60%" placeholder="Email"> <br>
            <input type="text" name="subjek" class="form-control" style="width: 60%" placeholder="Subjek"> <br>
            <textarea class="form-control" style="min-height: 150px" name="isiemail"></textarea> <br>
            <button type="submit" name="kirimemail" class="btn btn-success" style="width: 100%">Kirim</button>
          </div>
        </form>
    </div>
  </div>
