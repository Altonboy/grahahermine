...
require '../assets/core/init.php';
  ...
  $getpenghargaan = mysqli_query($connect, "SELECT * FROM fotopenghargaan");
?>
<html>
<head>
...
<div class="container" style="min-height: 100%">
  <iframe width="100%" height="480" src="https://www.youtube.com/embed/SOEhQ2NyO64" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>

  <br><br>

  <div style="width: 50%; background-color: rgb(0, 123, 59); margin: auto;"><hr></div>
  <br>

  <div class="profil">
    <h3> <b>PROFIL</b></h3>
    <img src="../assets/image/profil.jpg" width="180" height="240">
  </div>
  <br>
  <p>
    Salam Sejahtera Bagi Kita Semua, Puji dan syukur senantiasa kita haturkan kehadirat Tuhan Yang Maha Kuasa, yang telah memberikan rahmat dan kasihnya kepada kita semua. <br>
    Rumah Sakit Graha Hermine merupakan Rumah Sakit Swasta dibawah naungan PT. Batam Sehat Madani, yang bertujuan untuk menyelenggakan pelayanan kesehatan dengan upaya penyembuhan, pemulihan, peningkatan, pencegahan, pelayanan, rujukan dan pengembangan serta pengabdian masyakarat.<br>
    Rumah Sakit Graha Hermine berdiri pada tanggal 3 Desember 2009 telah memberikan kontribusi yang nyata dalam pelayanan kesehatan bagi masyarakat Batam. Berawal dari Rumah Bersalin lalu berkembang menjadi sebuah Rumah Sakit Umum dengan tipe kelas “C” berdasarkan penetapan dari Pemerintah melalui SK Wali Kota Batam Nomor: KPTS.00001/HK/III/2020 Tentang Pemberian Izin Operasional Tetap Rumah Sakit Umum Graha Hermine.<br>
  ...
  <div class="row">
    ...
    <div class="col-sm">
      <h3><b>MISI</b></h3>
      <p>
        • Memberikan pelayanan kesehatan yang cepat, tepat dan berkualitas.<br>
        • Mengutamakan kenyamanan dan keselamatan pasien.<br>
        • Memberikan pelayanan kesehatan yang terjangkau dan kesejahteraan oleh seluruh lapisan masyarakat.<br>
        • Meningkatkan pengetahuan, keterampilan karyawan, sehingga mampu melaksanakan pelayanan yang profesional.<br>
  ...
  <br>
      ...
      <h3><b>PENGHARGAAN</b></h3>
      <div class="penghargaan">
        <?php
          while ($listpenghargaan = mysqli_fetch_array($getpenghargaan)) {
            echo"<a><img title='".$listpenghargaan['judulFoto']."' src='../assets/images/".$listpenghargaan['namaFoto']."'></a>";
          } ?>
      </div>
