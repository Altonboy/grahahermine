...
<div class="container" style="min-height: 100%;">
  <h3><?php echo $kategori?> - <?php echo $nama ?></h3>
  <div style="width: 100%; background-color: rgb(0, 123, 59); margin: auto;">
  <hr>
</div>
 <br>
  <img class="utama-img" width="300px" src="../assets/images/<?php echo $fotoutama?>" data-url="../assets/images/<?php echo $fotoutama?>">


  <?php if (!empty ($foto2)) { ?>
    <img class="kedua-img" width="300px" src="../assets/images/<?php echo $foto2?>" data-url="../assets/images/<?php echo $foto2?>">
    <?php
  }
  ?>

  <?php if (!empty ($foto3)) { ?>
    <img class="ketiga-img" width="300px" src="../assets/images/<?php echo $foto3?>" data-url="../assets/images/<?php echo $foto3?>">
    <?php
  }
  ?>
  <br>
  <br>
  <p style="text-align: justify; white-space: pre-wrap;"> <?php echo $deskripsi; ?></p>
</div> <br>
