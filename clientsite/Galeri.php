...
require '../assets/core/init.php';
  ...
  $getgaleri = mysqli_query($connect, "SELECT * FROM galeri");
?>
<html>
<head>
...
<div class="container" style="min-height: 100%;">
  ...
  <div class="galeri">
    <?php
      while ($listgaleri = mysqli_fetch_array($getgaleri)) {
        echo"<div class='imgcontainer'>";
          echo"<img class='galeri-img' data-url='../assets/images/".$listgaleri['namaFoto']."' title='".$listgaleri['judulFoto']."' src='../assets/images/".$listgaleri['namaFoto']."' width=100%>";
        echo"</div>";
  }?>
  </div>
</div> <br>
